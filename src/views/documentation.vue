<template lang="pug">
.page-container
  header.text-center.w-flex.column.align-center.gap3
    svg.mb2(xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" xml:space="preserve" width="4em")
    ...
    .w-flex.no-grow.align-center.relative
      h1.title1.mb0.lh0 Splitpanes
      .version.code.ml2.grey.op5.size--xs.mt1 {{ version }}
